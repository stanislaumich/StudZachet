object ReportData: TReportData
  ...
  object ADOConnection2: TADOConnection
    ConnectionString = 'Provider=Microsoft.Jet.OLEDB.4.0;Data Source='#39'Northwind.MDB'#39';'
    LoginPrompt = False
    Mode = cmRead
    Provider = 'Microsoft.Jet.OLEDB.4.0'
    Left = 364
  ...
  object ADOConnection3: TADOConnection
    ConnectionString = 'Provider=Microsoft.Jet.OLEDB.4.0;Data Source='#39'DatabaseOrg.mdb'#39';'
    LoginPrompt = False
  ...
  object OrgSourceDB: TfrxDBDataset
    UserName = 'Org'
    CloseDataSource = False
  ...
  object TreeMap: TADOTable
    Connection = ADOConnection3
    TableName = 'TreeMap'
    Left = 376
    Top = 448
  end
  object TeeMapSource: TDataSource
    DataSet = TreeMap
    Left = 376
    Top = 496
  end
  object TeeMapDB: TfrxDBDataset
    UserName = 'TeeMap'
    CloseDataSource = False
    DataSource = TeeMapSource
    BCDToCurrency = False
    Left = 376
    Top = 544
  end
  object OHLC_Query: TADOQuery
    Active = True
    ConnectionString = 
      'Provider=Microsoft.Jet.OLEDB.4.0;Data Source=D:\Git FR\Main\;Ext' +
      'ended Properties="text;";Persist Security Info=False'
    CursorType = ctStatic
    Parameters = <>
    SQL.Strings = (
      'SELECT * FROM [EURUSD_200201_200410#csv]')
    Left = 472
    Top = 448
  end
  object OHLC_Source: TDataSource
    DataSet = OHLC_Query
    Left = 472
    Top = 504
  end
  object OHLC_DB: TfrxDBDataset
    UserName = 'OHLC'
    CloseDataSource = False
    DataSource = OHLC_Source
    BCDToCurrency = False
    Left = 472
    Top = 552
  end
  object JSON_DS: TfrxUserDataSet
    RangeEnd = reCount
    UserName = 'frxUserDataSetJSON'
    OnGetValue = JSON_DSGetValue
    Left = 544
    Top = 448
  end
end
