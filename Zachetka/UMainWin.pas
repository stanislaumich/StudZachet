...
begin
    { if StringGrid1.cells[0, StringGrid1.row] = '' then
      ...
      StatusBar1.Panels[0].Text := '”же есть ' + StringGrid1.cells
...
begin
    ...
    begin
        ...
        DownQuery.Refresh;
        StatusBar1.Panels[0].Text := 'ƒобавлен ' + StringGrid1.cells
          [1, StringGrid1.row] + ' ' + StringGrid1.cells[2, StringGrid1.row];
    end
    else
        StatusBar1.Panels[0].Text := '”же есть ' + StringGrid1.cells
...
begin
    ...
    end;
    {
      ...
      // заполн€ем 4 значени€, или сколько выйдет
      begin
...
begin
    DownQuery.last;
    StatusBar1.Panels[1].Text := '¬ таблице: ' +
